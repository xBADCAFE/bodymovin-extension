...
export function getBlendMode(value: any): number {
  let blendModeValue: number = blendModes.normal;
  switch (value) {
...
export function getBlendModeShape(value: any): number {
  let blendModeValue: number = blendModes.normal;
  switch (value) {
...
export const bm_blendModes = { getBlendMode, getBlendModeShape };
