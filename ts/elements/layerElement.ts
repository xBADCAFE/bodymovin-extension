var completeCallback: any;

var compCount = 0;

function prepareLayer(layerInfo: any, shouldIncludeAVAssets?: boolean): any {
...
function checkLayerSource(layerInfo: any, layerData: any): void {
  var layerTypes = $.__bodymovin.layerTypes;
  var settingsHelper = $.__bodymovin.bm_settingsHelper;
...
function renderLayer(layerOb: any, includeHiddenData: boolean, callback: any): void {
  var layerTypes = $.__bodymovin.layerTypes;
  var bm_generalUtils = $.__bodymovin.bm_generalUtils;
  ...
  if (lType === layerTypes.shape) {
    var extraParams: any = { is_rubberhose_autoflop: false };
