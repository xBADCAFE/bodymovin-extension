function getJustification(value: number): number | undefined {
    switch (value) {
...
function findLineHeight(textDocument: any): number {
...
function exportTextDocumentData(layerInfo: any, data: any, frameRate: number, stretch: number): void {
    ...
    for(j=0;j<jLen;j+=1){
        var ob: any = {};
        var textDocument: any, time: number;
        if(numKeys === 0){
            time = 0;
...
function removeLayerAnimators(layerInfo: any): void {
    var textProperty = layerInfo.property("Text");
    var i: number, len = textProperty.numProperties;
    for (i = 0; i < len; i += 1) {
...
function removeAnimators(layerInfo: any): void {
    var i: number, len = layerInfo.numProperties;
    for (i = 0; i < len; i += 1) {
...
function exportTextPathData(pathOptions: any, ob: any, masksProperties: any, frameRate: number, stretch: number): void {
...
function exportMoreOptionsData(pathOptions: any, ob: any, frameRate: number, stretch: number): void {
    var bm_keyframeHelper = $.__bodymovin.bm_keyframeHelper;
...
function exportAnimators(layerInfo: any, animatorArr: any[], frameRate: number, stretch: number): void {
...
function exportText(layerInfo: any, layerOb: any, frameRate: number): void {
    layerOb.t = {
        d: {},
        p: {},
        m: {}
