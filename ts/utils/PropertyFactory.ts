declare var Matrix: { new (): any };
declare var TrimTransformerProperty: { new (prop: any, trims: any): any };
...
function getValue(this: any) {
    ...
    if (frameNum === this.lastFrame || (this.lastFrame !== initFrame && ((this.lastFrame >= this.keyframes[this.keyframes.length - 1].t - this.offsetTime && frameNum >= this.keyframes[this.keyframes.length - 1].t - this.offsetTime) || (this.lastFrame < this.keyframes[0].t - this.offsetTime && frameNum < this.keyframes[0].t - this.offsetTime)))) {
        ...
        var i = 0, len = this.keyframes.length - 1, dir = 1, flag = true, keyData: any, nextKeyData: any;
        ...
        var k: number, kLen: number, perc: number, jLen: number, j = 0, fnc: any;
        if (keyData.to) {
            ...
            var outX: number, outY: number, inX: number, inY: number, isArray = false, keyValue: number;
...
function interpolateShape(this: any) {
    var bez = $.__bodymovin.bez;
    this.mdf = false;
    var frameNum = this.comp.renderedFrame - this.offsetTime;
    if(this.lastFrame !== initFrame && ((this.lastFrame < this.keyframes[0].t-this.offsetTime && frameNum < this.keyframes[0].t-this.offsetTime) || (this.lastFrame > this.keyframes[this.keyframes.length - 1].t-this.offsetTime && frameNum > this.keyframes[this.keyframes.length - 1].t-this.offsetTime))){
        ...
        var keyPropS: any,keyPropE: any,isHold: boolean;
        if(frameNum < this.keyframes[0].t-this.offsetTime){
            ...
            this.mdf = true;
            var i = 0,len = this.keyframes.length- 1, dir = 1,flag = true,keyData: any,nextKeyData: any, j: number, jLen: number, k: number, kLen: number;
...
function getKeys(this: any, arr: any[]){
    ...
    if(!this.keyframes){
        ...
        var j: number, jLen = this.keyframes.length,found: boolean;
        for(j=0;j<jLen;j+=1){
            i = 0;
            found = false;
            while(i<len){
...
function ValueProperty(this: any, elem: any,data: any, mult: any){
    this.mult = mult;
...
function MultiDimensionalProperty(this: any, elem: any,data: any, mult: any){
    this.mult = mult;
    this.mdf = false;
    this.comp = elem.comp;
    this.k = false;
    ...
    this.getKeys = getKeys;
    var i: number, len = data.k.length;
    for(i = 0;i<len;i+=1){
...
function KeyframedValueProperty(this: any, elem: any, data: any, mult: any){
...
function KeyframedMultidimensionalProperty(this: any, elem: any, data: any, mult: any){
    this.keyframes = data.k;
    this.offsetTime = elem.data.st;
    this.k = true;
    this.mult = mult;
...
var TransformProperty: any = (function(){
    function getKeys(this: any, arr: any[]){
        this.a.getKeys(arr);
        this.p.getKeys(arr);
        this.s.getKeys(arr);
    ...
    function processKeys(this: any){
        if(this.elem.globalData.frameId === this.frameId){
            return;
        }
        this.mdf = false;
        this.frameId = this.elem.globalData.frameId;
        var i: number, len = this.dynamicProperties.length;
    ...
    return function(this: any, elem: any,data: any,arr: any[]){
        this.elem = elem;
        this.frameId = -1;
...
function getProp(elem: any,data: any,type: number, mult: any, arr: any[]) {
    var p: any;
    if(type === 2){
        p = new (TransformProperty as any)(elem, data, arr);
    }else if(!data.k.length){
        p = new (ValueProperty as any)(elem,data, mult);
    }else if(typeof(data.k[0]) === 'number'){
        p = new (MultiDimensionalProperty as any)(elem,data, mult);
    }else{
        switch(type){
            case 0:
                p = new (KeyframedValueProperty as any)(elem,data,mult);
                break;
            case 1:
                p = new (KeyframedMultidimensionalProperty as any)(elem,data,mult);
                break;
        }
    }
    if(p.k || p.x){
...
function ShapeProperty(this: any, elem: any, data: any, type: number){
    this.comp = elem.comp;
    this.k = false;
    this.mdf = false;
...
function KeyframedShapeProperty(this: any, elem: any,data: any,type: number){
    this.comp = elem.comp;
    this.offsetTime = elem.data.st;
    ...
    this.k = true;
    this.closed = type === 3 ? data.cl : data.closed;
    var i: number, len = this.keyframes[0].s[0].i.length;
...
var EllShapeProperty: any = (function(){

    var cPoint = 0.5519;

    function convertEllToPath(this: any){
    ...
    function processKeys(this: any, frameNum?: number){
        var i: number, len = this.dynamicProperties.length;
        if(this.elem.globalData.frameId === this.frameId){
            return;
        }
    ...
    return function(this: any, elem: any,data: any) {
        this.v = {
            v: new Array(4),
            i: new Array(4),
            o: new Array(4),
...
var RectShapeProperty: any = (function() {
    function processKeys(this: any, frameNum?: number){
        if(this.elem.globalData.frameId === this.frameId){
            return;
        }
    ...
    function convertRectToPath(this: any){
...
var StarShapeProperty: any = (function() {

    function convertPolygonToPath(this: any){
        ...
        var i: number, currentAng = -Math.PI/ 2;
    ...
    function convertStarToPath(this: any) {
        ...
        var i: number, rad: number,roundness: number,perimSegment: number, currentAng = -Math.PI/ 2;
        currentAng += this.r.v;
        var dir = this.data.d === 3 ? -1 : 1;
        for(i=0;i<numPts;i+=1){
    ...
    return function StarShapeProperty(this: any, elem: any,data: any) {
        this.v = {
            v: [],
            i: [],
            o: [],
...
function getShapeProp(elem: any,data: any,type: number, arr: any[], trims?: any[]){
    var prop: any;
    if(type === 3 || type === 4){
        var keys = type === 3 ? data.pt.k : data.ks.k;
        if(keys.length){
            prop = new (KeyframedShapeProperty as any)(elem, data, type);
        }else{
            prop = new (ShapeProperty as any)(elem, data, type);
        }
    }else if(type === 5){
