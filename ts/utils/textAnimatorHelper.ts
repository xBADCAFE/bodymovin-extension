function exportTextSelectors(layerInfo: any, frameRate: number, stretch: number): any {
    var bm_keyframeHelper = $.__bodymovin.bm_keyframeHelper;
    var bm_expressionHelper = $.__bodymovin.bm_expressionHelper;
    var settingsHelper = $.__bodymovin.bm_settingsHelper;
    var selectors: any[] = [];

    function exportSelector(selectorProperty: any) {
    ...
    function exportExpressibleSelector(selectorProperty: any) {
        if (!selectorProperty) return;
...
function exportAnimationSelector(layerInfo: any, frameRate: number, stretch: number): any {
    var bm_keyframeHelper = $.__bodymovin.bm_keyframeHelper;
    var ob: any = {};
    var i: number, len: number, property: any, propertyName: string;
...
function exportAnimator(layerInfo: any, ob: any, frameRate: number, stretch: number): void {
...
export const bm_textAnimatorHelper = {
