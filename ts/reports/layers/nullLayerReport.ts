...
function NullLayer(this: any, layer: any, onComplete: any, onFail: any): void {
  this.layer = layer;
...
NullLayer.prototype.processLayer = function (): void {
  this.layerReport = layerReport(this.layer);
};

NullLayer.prototype.process = function (): void {
  try {
    this.processLayer();
    this._onComplete();
  } catch (error) {
...
NullLayer.prototype.serialize = function (): any {
...
export function bm_nullLayerReport(layer: any, onComplete: any, onFail: any): any {
  return new (NullLayer as any)(layer, onComplete, onFail);
}
