...
function AudioLayer(this: any, layer: any, onComplete: any, onFail: any): void {
  this.layer = layer;
...
AudioLayer.prototype.processLayer = function (): void {
  this.layerReport = layerReport(this.layer);
};

AudioLayer.prototype.processType = function (): void {
...
AudioLayer.prototype.process = function (): void {
  try {
    this.processLayer();
    this.processType();
    this._onComplete();
...
AudioLayer.prototype.serialize = function (): any {
...
export function bm_audioLayerReport(layer: any, onComplete: any, onFail: any): any {
  return new (AudioLayer as any)(layer, onComplete, onFail);
}
