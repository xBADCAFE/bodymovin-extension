...
function ImageLayer(this: any, layer: any, onComplete: any, onFail: any): void {
  this.layer = layer;
...
ImageLayer.prototype.processLayer = function (): void {
  this.layerReport = layerReport(this.layer);
};

ImageLayer.prototype.processImage = function (): void {
...
ImageLayer.prototype.process = function (): void {
  try {
    this.processLayer();
    this.processImage();
    this._onComplete();
...
ImageLayer.prototype.serialize = function (): any {
...
export function bm_imageLayerReport(layer: any, onComplete: any, onFail: any): any {
  return new (ImageLayer as any)(layer, onComplete, onFail);
}
